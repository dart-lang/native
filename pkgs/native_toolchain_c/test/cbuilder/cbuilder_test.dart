...
void main() {
    ...
    for (final buildMode in BuildMode.values) {
      ...
      test('CBuilder executable$suffix', () async {
        ...
        final helloWorldCUri = packageUri
            .resolve('test/cbuilder/testdata/hello_world/src/hello_world.c');
  ...
  test('CBuilder flags', () async {
    final tempUri = await tempDirForTest();
    final definesCUri =
        packageUri.resolve('test/cbuilder/testdata/defines/src/defines.c');
  ...
  test('CBuilder includes', () async {
    ...
    final includeDirectoryUri =
        packageUri.resolve('test/cbuilder/testdata/includes/include');
    final includesHUri = packageUri
        .resolve('test/cbuilder/testdata/includes/include/includes.h');
    final includesCUri =
        packageUri.resolve('test/cbuilder/testdata/includes/src/includes.c');
    const name = 'includes';
  ...
  test('CBuilder compile c++', () async {
    ...
    final helloWorldCppUri = packageUri.resolve(
        'test/cbuilder/testdata/hello_world_cpp/src/hello_world_cpp.cc');
