...
///
/// Example:
/// <!-- file://./../../../example/api/jbyte_buffer_snippet.dart#allocate_direct -->
/// ```dart
...
///
/// Example:
/// <!-- file://./../../../example/api/jbyte_buffer_snippet.dart#release_buffer -->
/// ```dart
/// final directBuffer = JByteBuffer.allocateDirect(3);
...
///
/// Example:
/// <!-- file://./../../../example/api/jbyte_buffer_snippet.dart#release_original -->
/// ```dart
/// final directBuffer = JByteBuffer.allocateDirect(3);
