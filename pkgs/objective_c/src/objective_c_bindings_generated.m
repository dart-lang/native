...
typedef void  (^_ListenerTrampoline1)(id arg0, id arg1);
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline1 _ObjectiveCBindings_wrapListenerBlock_pfv6jd(_ListenerTrampoline1 block) NS_RETURNS_RETAINED {
...
typedef void  (^_BlockingTrampoline1)(void * waiter, id arg0, id arg1);
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline1 _ObjectiveCBindings_wrapBlockingBlock_pfv6jd(
