...
const foundationConfig = 'ffigen_foundation.yaml';
...
const foundationBindings = 'lib/src/foundation_bindings_generated.dart';
const cBindings = 'lib/src/c_bindings_generated.dart';
const objcBindings = 'lib/src/objective_c_bindings_generated.dart';
const foundationExports = 'lib/src/foundation_bindings_exported.dart';
...
export 'foundation_bindings_generated.dart'
    show
        ${exports.join(',\n        ')};
''');
}
...
Future<void> run({required bool format}) async {
  ...
  print('Generating foundation bindings...');
  await ffigen.main([...ffigenFlags, foundationConfig]);
  mergeExtraMethods(foundationBindings, parseExtraMethods(extraMethodsFile));

  print('Generating objc_built_in_types.dart...');
  final exports = writeBuiltInTypes(foundationConfig, builtInTypes);

  print('Generating foundation_bindings_exported.dart...');
  writeExports(exports, foundationExports);
