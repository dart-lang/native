...
@ffi.Native<
  ffi.Void Function(ffi.Pointer<ObjCBlockImpl>, ffi.Pointer<ObjCBlockImpl>)
>(symbol: 'DOBJC_copyObjCBlockWithClosure', isLeaf: true)
external void copyObjCBlockWithClosure(
  ffi.Pointer<ObjCBlockImpl> dst,
  ffi.Pointer<ObjCBlockImpl> src,
);
...
@ffi.Native<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>(
  symbol: 'DOBJC_getBlockContext',
  isLeaf: true,
)
external ffi.Pointer<ffi.Void> getBlockContext(ffi.Pointer<ffi.Void> block);

@ffi.Native<ffi.Int64 Function(ffi.Pointer<ffi.Void>)>(
  symbol: 'DOBJC_getBlockPortId',
  isLeaf: true,
)
external int getBlockPortId(ffi.Pointer<ffi.Void> block);
...
@ffi.Native<ffi.Void Function()>(symbol: 'DOBJC_noop', isLeaf: true)
external void noop();
...
>(symbol: 'DOBJC_postCObject', isLeaf: true)
external bool postCObject(
  int port_id,
...
final class DOBJC_Context extends ffi.Struct {
  ...
  external ffi.Pointer<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> waiter)>
  >
  signalWaiter$1;

  external ffi.Pointer<
    ffi.NativeFunction<ffi.Int64 Function(ffi.Pointer<ffi.Void> block)>
  >
  getBlockPortId$1;

  external ffi.Pointer<
    ffi.NativeFunction<
      ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void> block)
    >
  >
  getBlockContext$1;
  ...
  static ffi.Pointer<DOBJC_Context> $allocate(
    ...
    ..ref.runOnMainThread$1 = runOnMainThread$1
    ..ref.signalWaiter$1 = signalWaiter$1
    ..ref.getBlockPortId$1 = getBlockPortId$1
    ..ref.getBlockContext$1 = getBlockContext$1;
}
...
final class PortBlockTarget extends ffi.Struct {
  @ffi.Int64()
  external int port_id;

  external ffi.Pointer<DOBJC_Context> ctx;

  static ffi.Pointer<PortBlockTarget> $allocate(
    ffi.Allocator $allocator, {
    required int port_id,
    required ffi.Pointer<DOBJC_Context> ctx,
  }) => $allocator<PortBlockTarget>()
    ..ref.port_id = port_id
    ..ref.ctx = ctx;
}
