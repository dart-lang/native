...
@ffi.Native<ffi.Pointer<ObjCObject> Function(ffi.Pointer<ObjCObject> )>(symbol: 'objc_retainBlock', isLeaf: true)
external ffi.Pointer<ObjCObject> blockRetain(ffi.Pointer<ObjCObject> object,
);

@ffi.Native<ffi.Pointer<ffi.Pointer<ObjCObject>> Function(ffi.Pointer<ffi.UnsignedInt> )>(symbol: 'objc_copyClassList', isLeaf: true)
external ffi.Pointer<ffi.Pointer<ObjCObject>> copyClassList(ffi.Pointer<ffi.UnsignedInt> count,
);
...
@ffi.Native<ffi.Pointer<ObjCObject> Function(ffi.Pointer<ffi.Char> )>(symbol: 'objc_getClass', isLeaf: true)
external ffi.Pointer<ObjCObject> getClass(ffi.Pointer<ffi.Char> name,
);

@ffi.Native<ObjCMethodDesc Function(ffi.Pointer<ObjCProtocol> , ffi.Pointer<ObjCSelector> , ffi.Bool , ffi.Bool )>(symbol: 'protocol_getMethodDescription', isLeaf: true)
external ObjCMethodDesc getMethodDescription(ffi.Pointer<ObjCProtocol> protocol,
...
@ffi.Native<ffi.Pointer<ObjCObject> Function(ffi.Pointer<ObjCObject> )>(symbol: 'object_getClass', isLeaf: true)
...
@ffi.Native<ffi.Pointer<ObjCProtocol> Function(ffi.Pointer<ffi.Char> )>(symbol: 'objc_getProtocol', isLeaf: true)
external ffi.Pointer<ObjCProtocol> getProtocol(ffi.Pointer<ffi.Char> name,
);

@ffi.Native<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ObjCProtocol> )>(symbol: 'protocol_getName', isLeaf: true)
...
@ffi.Native<Dart_FinalizableHandle Function(ffi.Handle , ffi.Pointer<ObjCObject> )>(symbol: 'DOBJC_newFinalizableHandle')
...
@ffi.Native<ffi.Pointer<ObjCObject> Function(ffi.Pointer<ObjCObject> )>(symbol: 'objc_autorelease', isLeaf: true)
external ffi.Pointer<ObjCObject> objectAutorelease(ffi.Pointer<ObjCObject> object,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<ObjCObject> )>(symbol: 'objc_release', isLeaf: true)
external void objectRelease(ffi.Pointer<ObjCObject> object,
);

@ffi.Native<ffi.Pointer<ObjCObject> Function(ffi.Pointer<ObjCObject> )>(symbol: 'objc_retain', isLeaf: true)
...
final class DOBJC_Context extends ffi.Struct{
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function()>> newWaiter;

  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> )>> awaitWaiter;
