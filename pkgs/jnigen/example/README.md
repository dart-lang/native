...
- Write the JNIgen config similar to [the one in pdfbox_plugin](https://github.com/dart-lang/native/tree/main/pkgs/jnigen/example/pdfbox_plugin/tool/jnigen.dart).
- Generate JNI bindings by running `dart run tool/jnigen.dart`.
...
- Generate JNI bindings as described above. See [notification_plugin](https://github.com/dart-lang/native/tree/main/pkgs/jnigen/example/notification_plugin/tool/jnigen.dart) for example configuration.
