...
Future<void> main() async {
  test(
    'Generated JNIgen bindings should pass dart analyze',
    () async {
      ...
      if (update) {
        ...
        print(
          'Skipping Java code gen. Set UPDATE=true to '
      ...
      final analyzeResult = await Process.run('dart', [
        'analyze',
        'test/large_java_test/lib/large_bindings.dart',
      ], workingDirectory: pkgDir);
      expect(
