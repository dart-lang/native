...
///
extension type MatchStrength._(jni$_.JObject _$this) implements jni$_.JObject {
  static const jni$_.JType<MatchStrength> type = $MatchStrength$Type$();
}

final class $MatchStrength$Type$ extends jni$_.JType<MatchStrength> {
  @jni$_.internal
  const $MatchStrength$Type$();

  @jni$_.internal
  @core$_.override
  String get signature => r'Lcom/fasterxml/jackson/core/format/MatchStrength;';
}
