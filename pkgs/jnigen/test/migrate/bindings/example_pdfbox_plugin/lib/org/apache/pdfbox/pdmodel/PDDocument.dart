...
extension type PDDocument._(jni$_.JObject _$this)
  ...
  factory PDDocument.new$2(cosdocument$_.COSDocument? doc) {
    final _$$classRef = _class.reference;
  ...
  static PDDocument? load(file$_.File? file) {
    final _$$classRef = _class.reference;
  ...
  ///@throws IOException in case of a file reading or parsing error
  static PDDocument? load$2(file$_.File? file, jni$_.JString? password) {
    final _$$classRef = _class.reference;
    final _$file = file?.reference ?? jni$_.jNullReference;
  ...
  static PDDocument? load$6(inputstream$_.InputStream? input) {
    final _$$classRef = _class.reference;
...
extension PDDocument$$Methods on PDDocument {
  ...
  void addPage(pdpage$_.PDPage? page) {
  ...
  /// fields.
  void addSignature(pdsignature$_.PDSignature? sigObject) {
    final _$$selfRef = reference;
  ...
  void removePage(pdpage$_.PDPage? page) {
    final _$$selfRef = reference;
    final _$page = page?.reference ?? jni$_.jNullReference;
    _removePage(
      _$$selfRef.pointer,
  ...
  pdpage$_.PDPage? importPage(pdpage$_.PDPage? page) {
    final _$$selfRef = reference;
    final _$page = page?.reference ?? jni$_.jNullReference;
    return _importPage(
      _$$selfRef.pointer,
  ...
  ///@param ttf
  void registerTrueTypeFontForClosing(truetypefont$_.TrueTypeFont? ttf) {
    final _$$selfRef = reference;
  ...
  ///@throws IOException if the output could not be written
  void save$2(outputstream$_.OutputStream? output) {
    final _$$selfRef = reference;
  ...
  void saveIncremental(outputstream$_.OutputStream? output) {
    final _$$selfRef = reference;
    final _$output = output?.reference ?? jni$_.jNullReference;
    _saveIncremental(
      _$$selfRef.pointer,
  ...
  saveIncrementalForExternalSigning(outputstream$_.OutputStream? output) {
    final _$$selfRef = reference;
    final _$output = output?.reference ?? jni$_.jNullReference;
  ...
  pdpage$_.PDPage? getPage(core$_.int pageIndex) {
    final _$$selfRef = reference;
    return _getPage(
      _$$selfRef.pointer,
      _id_getPage.pointer,
  ...
  void protect(protectionpolicy$_.ProtectionPolicy? policy) {
    final _$$selfRef = reference;
