...
ClassDecl _$ClassDeclFromJson(Map<String, dynamic> json) => ClassDecl(
  ...
  modifiers:
      (json['modifiers'] as List<dynamic>?)?.map((e) => e as String).toSet() ??
      const {},
  binaryName: json['binaryName'] as String,
  typeParams:
      (json['typeParams'] as List<dynamic>?)
  ...
  kotlinPackage: json['kotlinPackage'] == null
      ? null
      : KotlinPackage.fromJson(json['kotlinPackage'] as Map<String, dynamic>),
);
...
ArrayType _$ArrayTypeFromJson(Map<String, dynamic> json) => ArrayType(
  elementType: ReferredType.fromJson(
...
Method _$MethodFromJson(Map<String, dynamic> json) => Method(
  ...
  params:
      (json['params'] as List<dynamic>?)
          ...
          .toList() ??
      const [],
  returnType: ReferredType.fromJson(json['returnType'] as Map<String, dynamic>),
);
...
JavaDocComment _$JavaDocCommentFromJson(Map<String, dynamic> json) =>
    JavaDocComment(comment: json['comment'] as String? ?? '');
...
KotlinClass _$KotlinClassFromJson(Map<String, dynamic> json) => KotlinClass(
  ...
  contextReceiverTypes:
      (json['contextReceiverTypes'] as List<dynamic>?)
  ...
  superTypes:
      ...
      const [],
  nestedClasses:
      (json['nestedClasses'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  enumEntries:
      (json['enumEntries'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  sealedClasses:
      (json['sealedClasses'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
...
KotlinFunction _$KotlinFunctionFromJson(
  ...
  valueParameters:
      (json['valueParameters'] as List<dynamic>?)
          ?.map((e) => KotlinValueParameter.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
  returnType: KotlinType.fromJson(json['returnType'] as Map<String, dynamic>),
...
KotlinConstructor _$KotlinConstructorFromJson(Map<String, dynamic> json) =>
    KotlinConstructor(
      ...
      valueParameters:
          (json['valueParameters'] as List<dynamic>?)
              ?.map(
                (e) => KotlinValueParameter.fromJson(e as Map<String, dynamic>),
              )
              .toList() ??
          const [],
      flags: (json['flags'] as num).toInt(),
...
KotlinProperty _$KotlinPropertyFromJson(
  Map<String, dynamic> json,
) => KotlinProperty(
...
KotlinType _$KotlinTypeFromJson(Map<String, dynamic> json) => KotlinType(
  ...
  arguments:
      (json['arguments'] as List<dynamic>?)
          ?.map((e) => KotlinTypeArgument.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
);
...
KotlinTypeParameter _$KotlinTypeParameterFromJson(Map<String, dynamic> json) =>
    KotlinTypeParameter(
      ...
      flags: (json['flags'] as num).toInt(),
      upperBounds:
          (json['upperBounds'] as List<dynamic>?)
              ?.map((e) => KotlinType.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
...
KotlinValueParameter _$KotlinValueParameterFromJson(
  ...
  varargElementType: json['varargElementType'] == null
      ? null
      : KotlinType.fromJson(json['varargElementType'] as Map<String, dynamic>),
);
