...
class NativeLibraryASharedB {
  ...
  void a_func2(imp$1.BaseStruct2 s, imp$1.BaseUnion2 u, imp$1.BaseTypedef2 t) {
  ...
  late final _a_func2 = _a_func2Ptr
      .asFunction<
        void Function(imp$1.BaseStruct2, imp$1.BaseUnion2, imp$1.BaseTypedef2)
      >();

  void a_func3(imp$1.DartBaseNativeTypedef1 i) {
    return _a_func3(i);
  }

  late final _a_func3Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(imp$1.BaseNativeTypedef1)>>(
        'a_func3',
      );
  late final _a_func3 = _a_func3Ptr
      .asFunction<void Function(imp$1.DartBaseNativeTypedef1)>();

  void a_func4(imp$1.DartBaseNativeTypedef1 i) {
    return _a_func4(i);
  }

  late final _a_func4Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(imp$1.BaseNativeTypedef2)>>(
        'a_func4',
      );
  late final _a_func4 = _a_func4Ptr
      .asFunction<void Function(imp$1.DartBaseNativeTypedef1)>();

  void a_func5(imp$1.DartBaseNativeTypedef1 i) {
    return _a_func5(i);
  }

  late final _a_func5Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(imp$1.BaseNativeTypedef3)>>(
        'a_func5',
      );
