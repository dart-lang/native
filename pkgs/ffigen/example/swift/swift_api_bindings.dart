...
class SwiftClass extends objc.NSObject {
  ...
  objc.NSString sayHello() {
    final _ret = _objc_msgSend_1x359cv(this.ref.pointer, _sel_sayHello);
  ...
  set someField(int value) {
    return _objc_msgSend_4sp4xj(this.ref.pointer, _sel_setSomeField_, value);
  }
  ...
  static SwiftClass new1() {
    final _ret = _objc_msgSend_1x359cv(_class_SwiftClass, _sel_new);
    return SwiftClass.castFromPointer(_ret, retain: false, release: true);
  }
  ...
  static SwiftClass allocWithZone_(ffi.Pointer<_NSZone> zone) {
    final _ret =
        _objc_msgSend_hzlb60(_class_SwiftClass, _sel_allocWithZone_, zone);
    return SwiftClass.castFromPointer(_ret, retain: false, release: true);
  }

  /// alloc
  static SwiftClass alloc() {
    final _ret = _objc_msgSend_1x359cv(_class_SwiftClass, _sel_alloc);
    return SwiftClass.castFromPointer(_ret, retain: false, release: true);
  }
