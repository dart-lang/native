...
extension type SwiftClass._(objc.ObjCObject object$)
  ...
  static SwiftClass alloc() {
    final $ret = _objc_msgSend_zldla2(_class_SwiftClass, _sel_alloc);
  ...
  static SwiftClass new$() {
    final $ret = _objc_msgSend_zldla2(_class_SwiftClass, _sel_new);
    return SwiftClass.fromPointer($ret, retain: false, release: true);
  }
...
extension SwiftClass$Methods on SwiftClass {
  ...
  objc.NSString sayHello() {
    final _$$ref = object$.ref;
    final $ret = _objc_msgSend_zldla2(_$$ref.pointer, _sel_sayHello);
  ...
  set someField(int value) {
    final _$$ref = object$.ref;
    _objc_msgSend_1whyqxt(_$$ref.pointer, _sel_setSomeField_, value);
  }

  /// someField
  int get someField {
    final _$$ref = object$.ref;
    return _objc_msgSend_18szuw0(_$$ref.pointer, _sel_someField);
  }
}
