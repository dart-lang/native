...
_ListenerTrampoline1 _SwiftLibrary_wrapListenerBlock_l9klhe(_ListenerTrampoline1 block) NS_RETURNS_RETAINED {
...
_ListenerTrampoline2 _SwiftLibrary_wrapListenerBlock_ukcdfq(_ListenerTrampoline2 block) NS_RETURNS_RETAINED {
  return ^void(id arg0) {
    objc_retainBlock(block);
...
_ListenerTrampoline3 _SwiftLibrary_wrapListenerBlock_1tjlcwl(_ListenerTrampoline3 block) NS_RETURNS_RETAINED {
...
_ListenerTrampoline4 _SwiftLibrary_wrapListenerBlock_sjfpmz(_ListenerTrampoline4 block) NS_RETURNS_RETAINED {
