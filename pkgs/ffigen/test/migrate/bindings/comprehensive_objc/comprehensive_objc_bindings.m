...
Protocol* _9v41hi_ComprehensiveProtocol(void) { return @protocol(ComprehensiveProtocol); }

__attribute__((visibility("default"))) __attribute__((used))
Protocol* _9v41hi_ProtocolOld(void) { return @protocol(ProtocolOld); }

__attribute__((visibility("default"))) __attribute__((used))
Protocol* _9v41hi_RegexProtocolA(void) { return @protocol(RegexProtocolA); }
