...
FfiGenerator getConfig({Uri? outputDir, Uri? packageRoot}) {
  ...
  final dartPath = outputDir != null
      ? outputDir.resolve('isolate_test_bindings.dart')
      : configDir.resolve('isolate_test_bindings.dart');
  final objcPath = outputDir != null
      ? outputDir.resolve('isolate_test_bindings.m')
      : configDir.resolve('isolate_test_bindings.m');
  return FfiGenerator(
    output: Output(
    ...
    input: Input(entryPoints: [configDir.resolve('isolate_test.h')]),
