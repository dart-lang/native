...
FfiGenerator getConfig({Uri? outputDir, Uri? packageRoot}) {
  ...
  final dartPath = outputDir != null
      ? outputDir.resolve('global_native_test_bindings.dart')
      : configDir.resolve('global_native_test_bindings.dart');
  final objcPath = outputDir != null
      ? outputDir.resolve('global_native_test_bindings.dart.m')
      : configDir.resolve('global_native_test_bindings.dart.m');
  return FfiGenerator(
    output: Output(
