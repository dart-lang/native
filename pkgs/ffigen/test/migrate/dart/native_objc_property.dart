...
FfiGenerator getConfig({Uri? outputDir, Uri? packageRoot}) {
  ...
  final dartPath = outputDir != null
      ? outputDir.resolve('property_test_bindings.dart')
      : configDir.resolve('property_test_bindings.dart');
  final objcPath = outputDir != null
      ? outputDir.resolve('property_test_bindings.dart.m')
      : configDir.resolve('property_test_bindings.dart.m');
  return FfiGenerator(
    output: Output(
    ...
    input: Input(entryPoints: [configDir.resolve('property_test.h')]),
