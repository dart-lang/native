...
FfiGenerator getConfig({Uri? outputDir, Uri? packageRoot}) {
  ...
  final dartPath = outputDir != null
      ? outputDir.resolve('error_method_test_bindings.dart')
      : configDir.resolve('error_method_test_bindings.dart');
  final objcPath = outputDir != null
      ? outputDir.resolve('error_method_test_bindings.dart.m')
      : configDir.resolve('error_method_test_bindings.dart.m');
  return FfiGenerator(
    output: Output(
    ...
    input: Input(entryPoints: [configDir.resolve('error_method_test.m')]),
