...
FfiGenerator getConfig({Uri? outputDir, Uri? packageRoot}) {
  ...
  final dartPath = outputDir != null
      ? outputDir.resolve('runtime_version_test_bindings.dart')
      : configDir.resolve('runtime_version_test_bindings.dart');
  final objcPath = outputDir != null
      ? outputDir.resolve('runtime_version_test_bindings.dart.m')
      : configDir.resolve('runtime_version_test_bindings.dart.m');
  return FfiGenerator(
    output: Output(
...
''',
    ...
    input: Input(entryPoints: [configDir.resolve('runtime_version_test.m')]),
