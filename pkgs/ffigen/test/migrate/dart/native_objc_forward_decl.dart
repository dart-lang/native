...
FfiGenerator getConfig({Uri? outputDir, Uri? packageRoot}) {
  ...
  final dartPath = outputDir != null
      ? outputDir.resolve('forward_decl_test_bindings.dart')
      : configDir.resolve('forward_decl_test_bindings.dart');
  final objcPath = outputDir != null
      ? outputDir.resolve('forward_decl_test_bindings.dart.m')
      : configDir.resolve('forward_decl_test_bindings.dart.m');
  return FfiGenerator(
    output: Output(
    ...
    input: Input(
      entryPoints: [
        configDir.resolve('forward_decl_test.h'),
        configDir.resolve('forward_decl_test.m'),
      ],
    ),
