...
FfiGenerator getConfig({Uri? outputDir, Uri? packageRoot}) {
  ...
  final dartPath = outputDir != null
      ? outputDir.resolve('is_instance_test_bindings.dart')
      : configDir.resolve('is_instance_test_bindings.dart');
  final objcPath = outputDir != null
      ? outputDir.resolve('is_instance_test_bindings.dart.m')
      : configDir.resolve('is_instance_test_bindings.dart.m');
  return FfiGenerator(
    output: Output(
    ...
    input: Input(entryPoints: [configDir.resolve('is_instance_test.m')]),
