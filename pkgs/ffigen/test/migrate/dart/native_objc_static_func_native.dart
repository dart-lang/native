...
FfiGenerator getConfig({Uri? outputDir, Uri? packageRoot}) {
  ...
  final dartPath = outputDir != null
      ? outputDir.resolve('static_func_native_test_bindings.dart')
      : configDir.resolve('static_func_native_test_bindings.dart');
  final objcPath = outputDir != null
      ? outputDir.resolve('static_func_native_test_bindings.dart.m')
      : configDir.resolve('static_func_native_test_bindings.dart.m');
  return FfiGenerator(
    output: Output(
