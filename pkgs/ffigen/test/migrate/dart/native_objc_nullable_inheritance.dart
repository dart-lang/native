...
FfiGenerator getConfig({Uri? outputDir, Uri? packageRoot}) {
  ...
  final dartPath = outputDir != null
      ? outputDir.resolve('nullable_inheritance_test_bindings.dart')
      : configDir.resolve('nullable_inheritance_test_bindings.dart');
  final objcPath = outputDir != null
      ? outputDir.resolve('nullable_inheritance_test_bindings.dart.m')
      : configDir.resolve('nullable_inheritance_test_bindings.dart.m');
  return FfiGenerator(
    output: Output(
    ...
    input: Input(
      entryPoints: [configDir.resolve('nullable_inheritance_test.m')],
    ),
