...
FfiGenerator getConfig({Uri? outputDir, Uri? packageRoot}) {
  ...
  final dartPath = outputDir != null
      ? outputDir.resolve('failed_to_load_test_bindings.dart')
      : configDir.resolve('failed_to_load_test_bindings.dart');
  final objcPath = outputDir != null
      ? outputDir.resolve('failed_to_load_test_bindings.dart.m')
      : configDir.resolve('failed_to_load_test_bindings.dart.m');
  return FfiGenerator(
    output: Output(
    ...
    input: Input(entryPoints: [configDir.resolve('failed_to_load_test.m')]),
