...
FfiGenerator getConfig({Uri? outputDir, Uri? packageRoot}) {
  ...
  final dartPath = outputDir != null
      ? outputDir.resolve('bad_override_test_bindings.dart')
      : configDir.resolve('bad_override_test_bindings.dart');
  final objcPath = outputDir != null
      ? outputDir.resolve('bad_override_test_bindings.dart.m')
      : configDir.resolve('bad_override_test_bindings.dart.m');
  return FfiGenerator(
    output: Output(
    ...
    input: Input(entryPoints: [configDir.resolve('bad_override_test.m')]),
