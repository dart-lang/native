...
// Enums declared inside a namespace or a record are named by their enclosing
// scopes, flattened with `$` to form a Dart identifier.
...
// An anonymous namespace, whose contents must be skipped.
namespace {
enum Hidden { hiddenValue = 1 };
}  // namespace
