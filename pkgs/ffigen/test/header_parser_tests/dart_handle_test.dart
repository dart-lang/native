...
import 'package:ffigen/src/code_generator/utils.dart' show dartExecutable;
...
${strings.compilerOpts}: '-I${path.join(path.dirname(path.dirname(dartExecutable)), "include")}'
