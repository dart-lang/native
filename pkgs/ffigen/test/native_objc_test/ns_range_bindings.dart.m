...
BOOL  _vy9kn_protocolTrampoline_e3qsqz(id target, void * sel) {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline _vy9kn_wrapListenerBlock_18v1jvf(_ListenerTrampoline block) NS_RETURNS_RETAINED {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline _vy9kn_wrapBlockingBlock_18v1jvf(
...
__attribute__((visibility("default"))) __attribute__((used))
void  _vy9kn_protocolTrampoline_18v1jvf(id target, void * sel, id arg1) {
...
__attribute__((visibility("default"))) __attribute__((used))
id  _vy9kn_protocolTrampoline_xr62hr(id target, void * sel, id arg1) {
