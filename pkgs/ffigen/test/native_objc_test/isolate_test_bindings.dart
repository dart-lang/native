...
>(isLeaf: true)
external ffi.Pointer<objc.ObjCBlockImpl> _rdx59v_wrapBlockingBlock_1f6q4sj(
  int port,
...
>(isLeaf: true)
external ffi.Pointer<objc.ObjCBlockImpl> _rdx59v_wrapListenerBlock_1f6q4sj(
  int port,
  ffi.Pointer<objc.DOBJC_Context> context,
);
...
abstract final class ObjCBlock_ffiVoid_Int32 {
  ...
  static objc.ObjCBlock<ffi.Void Function(ffi.Int32)> listener(
    ...
    return objc.ObjCBlock<ffi.Void Function(ffi.Int32)>(
      objc.newBlockPort(_rdx59v_wrapListenerBlock_1f6q4sj, (
  ...
  static objc.ObjCBlock<ffi.Void Function(ffi.Int32)> blocking(
    ...
    return objc.ObjCBlock<ffi.Void Function(ffi.Int32)>(
      objc.newBlockingBlockPort(_rdx59v_wrapBlockingBlock_1f6q4sj, (
        ffi.Pointer<objc.ObjCObjectImpl> rawArgs,
      ) {
        final args = _BlockArgs_1liq3c0.fromPointer(
          rawArgs,
...
extension type Sendable._(objc.ObjCObject object$)
  ...
  static Sendable alloc() {
    final $ret = _objc_msgSend_zldla2(_class_Sendable, _sel_alloc);
  ...
  /// new
  static Sendable new$() {
    final $ret = _objc_msgSend_zldla2(_class_Sendable, _sel_new);
    return Sendable.fromPointer($ret, retain: false, release: true);
  }
...
extension Sendable$Methods on Sendable {
  ...
  set value(int value) {
    final _$$ref = object$.ref;
    _objc_msgSend_1f6q4sj(_$$ref.pointer, _sel_setValue_, value);
  }

  /// value
  int get value {
    final _$$ref = object$.ref;
    return _objc_msgSend_1etqkvi(_$$ref.pointer, _sel_value);
  }
}
