...
>(isLeaf: true)
external ffi.Pointer<objc.ObjCBlockImpl> _xi9m3f_wrapBlockingBlock_1bqef4y(
...
>(isLeaf: true)
external ffi.Pointer<objc.ObjCBlockImpl> _xi9m3f_wrapListenerBlock_1bqef4y(
  ffi.Pointer<objc.ObjCBlockImpl> block,
);
...
abstract final class ObjCBlock_ffiVoid_Int32 {
  ...
  static objc.ObjCBlock<ffi.Void Function(ffi.Int32)> listener(
    ...
    final wrapper = _xi9m3f_wrapListenerBlock_1bqef4y(raw);
  ...
  static objc.ObjCBlock<ffi.Void Function(ffi.Int32)> blocking(
    ...
    final wrapper = _xi9m3f_wrapBlockingBlock_1bqef4y(
      raw,
      rawListener,
      objc.objCContext,
    );
