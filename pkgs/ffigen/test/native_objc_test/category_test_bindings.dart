...
@ffi.Native<ffi.Pointer<objc.ObjCProtocolImpl> Function()>(
  symbol: '_l3cf7j_CatTestProtocol',
)
external ffi.Pointer<objc.ObjCProtocolImpl> _protocol_CatTestProtocol_raw();
final _protocol_CatTestProtocol = objc.getProtocol(
  "CatTestProtocol",
  _protocol_CatTestProtocol_raw,
);
