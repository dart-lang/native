...
/// Animal
extension type Animal._(objc.ObjCObject object$) implements objc.ObjCObject,objc.NSObject {
  ...
  Animal.fromPointer(ffi.Pointer<objc.ObjCObjectImpl> other,
  ...
  static bool isA(objc.ObjCObject? obj) => obj == null 
      ? false 
      : _objc_msgSend_19nvye5(obj.ref.pointer, _sel_isKindOfClass_, _class_Animal);
  ...
  static Animal allocWithZone(ffi.Pointer<objc.NSZone> zone) {
    final $ret = _objc_msgSend_1cwp428(_class_Animal, _sel_allocWithZone_, zone);
    return Animal.fromPointer($ret, retain: false, release: true);
  }
...
extension Animal$Methods on Animal {
  ...
  Animal initWithName(objc.NSString name) {
    final $ret = _objc_msgSend_1sotr3r(object$.ref.retainAndReturnPointer(), _sel_initWithName_, name.ref.pointer);
    return Animal.fromPointer($ret, retain: false, release: true);
  }
