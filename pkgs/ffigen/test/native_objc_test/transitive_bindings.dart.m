...
Protocol* _1tiufry_DirectlyIncludedProtocol(void) { return @protocol(DirectlyIncludedProtocol); }

typedef int  (^_ProtocolTrampoline)(void * sel);
__attribute__((visibility("default"))) __attribute__((used))
int  _1tiufry_protocolTrampoline_1l0nlq(id target, void * sel) {
...
__attribute__((visibility("default"))) __attribute__((used))
id  _1tiufry_protocolTrampoline_1mbt9g9(id target, void * sel) {
