...
>()
external void _1g4xbk9_protocolTrampoline_18v1jvf(
...
>()
external ffi.Pointer<objc.ObjCObjectImpl> _1g4xbk9_protocolTrampoline_1mbt9g9(
  ffi.Pointer<objc.ObjCObjectImpl> target,
  ffi.Pointer<ffi.Void> arg0,
);
...
>()
external void _1g4xbk9_protocolTrampoline_6yc3kd(
  ffi.Pointer<objc.ObjCObjectImpl> target,
  ffi.Pointer<ffi.Void> arg0,
  ffi.Pointer<objc.ObjCObjectImpl> arg1,
);
...
>()
external ffi.Pointer<objc.ObjCObjectImpl> _1g4xbk9_protocolTrampoline_cww6wh(
  ffi.Pointer<objc.ObjCObjectImpl> target,
  ffi.Pointer<ffi.Void> arg0,
  ffi.Pointer<objc.ObjCObjectImpl> arg1,
);
...
>()
external ffi.Pointer<objc.ObjCObjectImpl> _1g4xbk9_protocolTrampoline_xr62hr(
  ffi.Pointer<objc.ObjCObjectImpl> target,
  ffi.Pointer<ffi.Void> arg0,
  ffi.Pointer<objc.ObjCObjectImpl> arg1,
);
...
>()
external EmptyBlock _1g4xbk9_protocolTrampoline_zb0vvk(
  ffi.Pointer<objc.ObjCObjectImpl> target,
  ffi.Pointer<ffi.Void> arg0,
);
...
>(isLeaf: true)
external ffi.Pointer<objc.ObjCBlockImpl> _1g4xbk9_wrapBlockingBlock_18v1jvf(
...
>(isLeaf: true)
external ffi.Pointer<objc.ObjCBlockImpl> _1g4xbk9_wrapBlockingBlock_1pl9qdv(
  ffi.Pointer<objc.ObjCBlockImpl> block,
  ffi.Pointer<objc.ObjCBlockImpl> listnerBlock,
  ffi.Pointer<objc.DOBJC_Context> context,
);
...
>(isLeaf: true)
external ffi.Pointer<objc.ObjCBlockImpl> _1g4xbk9_wrapBlockingBlock_6yc3kd(
  ffi.Pointer<objc.ObjCBlockImpl> block,
  ffi.Pointer<objc.ObjCBlockImpl> listnerBlock,
  ffi.Pointer<objc.DOBJC_Context> context,
);
...
>(isLeaf: true)
external ffi.Pointer<objc.ObjCBlockImpl> _1g4xbk9_wrapListenerBlock_18v1jvf(
  ffi.Pointer<objc.ObjCBlockImpl> block,
);
...
@ffi.Native<
  ffi.Pointer<objc.ObjCBlockImpl> Function(ffi.Pointer<objc.ObjCBlockImpl>)
>(isLeaf: true)
external ffi.Pointer<objc.ObjCBlockImpl> _1g4xbk9_wrapListenerBlock_1pl9qdv(
  ffi.Pointer<objc.ObjCBlockImpl> block,
);
...
@ffi.Native<
  ffi.Pointer<objc.ObjCBlockImpl> Function(ffi.Pointer<objc.ObjCBlockImpl>)
>(isLeaf: true)
external ffi.Pointer<objc.ObjCBlockImpl> _1g4xbk9_wrapListenerBlock_6yc3kd(
  ffi.Pointer<objc.ObjCBlockImpl> block,
);
...
interface class BlockAnnotationTestProtocol$Builder {
  ...
  static final listenConsumedObject_ =
      objc.ObjCProtocolListenableMethod<void Function(EmptyObject)>(
        ...
        ffi.Native.addressOf<
              ...
              >
            >(_1g4xbk9_protocolTrampoline_6yc3kd)
            .cast(),
  ...
  static final listenObject_ =
      objc.ObjCProtocolListenableMethod<void Function(EmptyObject)>(
        ...
        ffi.Native.addressOf<
              ...
              >
            >(_1g4xbk9_protocolTrampoline_18v1jvf)
            .cast(),
        objc.getProtocolMethodSignature(
          _protocol_BlockAnnotationTestProtocol,
          _sel_listenObject_,
  ...
  static final produceBlock =
      objc.ObjCProtocolMethod<DartEmptyBlock Function()>(
        ...
        ffi.Native.addressOf<
              ...
              >
            >(_1g4xbk9_protocolTrampoline_zb0vvk)
            .cast(),
        objc.getProtocolMethodSignature(
          _protocol_BlockAnnotationTestProtocol,
          _sel_produceBlock,
  ...
  static final produceObject = objc.ObjCProtocolMethod<EmptyObject Function()>(
    ...
    ffi.Native.addressOf<
          ...
          >
        >(_1g4xbk9_protocolTrampoline_1mbt9g9)
        .cast(),
    objc.getProtocolMethodSignature(
      _protocol_BlockAnnotationTestProtocol,
      _sel_produceObject,
  ...
  static final receiveConsumedObject_ =
      objc.ObjCProtocolMethod<EmptyObject Function(EmptyObject)>(
        ...
        ffi.Native.addressOf<
              ...
              >
            >(_1g4xbk9_protocolTrampoline_cww6wh)
            .cast(),
        objc.getProtocolMethodSignature(
          _protocol_BlockAnnotationTestProtocol,
          _sel_receiveConsumedObject_,
  ...
  static final receiveObject_ =
      objc.ObjCProtocolMethod<EmptyObject Function(EmptyObject)>(
        ...
        ffi.Native.addressOf<
              ...
              >
            >(_1g4xbk9_protocolTrampoline_xr62hr)
            .cast(),
        objc.getProtocolMethodSignature(
          _protocol_BlockAnnotationTestProtocol,
          _sel_receiveObject_,
...
abstract final class ObjCBlock_ffiVoid {
  ...
  static objc.ObjCBlock<ffi.Void Function()> listener(
    ...
    final wrapper = _1g4xbk9_wrapListenerBlock_1pl9qdv(raw);
  ...
  static objc.ObjCBlock<ffi.Void Function()> blocking(
    ...
    final wrapper = _1g4xbk9_wrapBlockingBlock_1pl9qdv(
      raw,
      rawListener,
      objc.objCContext,
    );
...
abstract final class ObjCBlock_ffiVoid_ffiVoid_EmptyObject {
  ...
  listener(
    ...
    final wrapper = _1g4xbk9_wrapListenerBlock_18v1jvf(raw);
    objc.objectRelease(raw.cast());
  ...
  blocking(
    ...
    final wrapper = _1g4xbk9_wrapBlockingBlock_18v1jvf(
      raw,
      rawListener,
      objc.objCContext,
    );
...
abstract final class ObjCBlock_ffiVoid_ffiVoid_EmptyObject$1 {
  ...
  listener(
    ...
    final wrapper = _1g4xbk9_wrapListenerBlock_6yc3kd(raw);
    objc.objectRelease(raw.cast());
    return objc.ObjCBlock<
      ffi.Void Function(ffi.Pointer<ffi.Void>, objc.Consumed<EmptyObject>)
    >(wrapper, retain: false, release: true);
  ...
  blocking(
    ...
    final wrapper = _1g4xbk9_wrapBlockingBlock_6yc3kd(
      raw,
      rawListener,
      objc.objCContext,
    );
