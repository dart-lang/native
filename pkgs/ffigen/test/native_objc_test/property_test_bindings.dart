...
extension type PropertyInterface._(objc.ObjCObject object$)
  ...
  static PropertyInterface alloc() {
    final $ret = _objc_msgSend_zldla2(_class_PropertyInterface, _sel_alloc);
  ...
  static PropertyInterface new$() {
    final $ret = _objc_msgSend_zldla2(_class_PropertyInterface, _sel_new);
    return PropertyInterface.fromPointer($ret, retain: false, release: true);
  }
...
extension PropertyInterface$Methods on PropertyInterface {
  ...
  double get doubleProperty {
    ...
    return objc.useMsgSendVariants
        ? _objc_msgSend_9pr6kkFpret(_$$ref.pointer, _sel_doubleProperty)
        : _objc_msgSend_9pr6kk(_$$ref.pointer, _sel_doubleProperty);
  }
  ...
  double get floatProperty {
    final _$$ref = object$.ref;
    return objc.useMsgSendVariants
        ? _objc_msgSend_kh8q6eFpret(_$$ref.pointer, _sel_floatProperty)
        : _objc_msgSend_kh8q6e(_$$ref.pointer, _sel_floatProperty);
  }
  ...
  int get readOnlyProperty {
    final _$$ref = object$.ref;
    return _objc_msgSend_1etqkvi(_$$ref.pointer, _sel_readOnlyProperty);
  }

  /// readWriteProperty
  int get readWriteProperty {
    final _$$ref = object$.ref;
    return _objc_msgSend_1etqkvi(_$$ref.pointer, _sel_readWriteProperty);
  }

  /// setDoubleProperty:
  set doubleProperty(double value) {
    final _$$ref = object$.ref;
    _objc_msgSend_q6vpml(_$$ref.pointer, _sel_setDoubleProperty_, value);
  }

  /// setFloatProperty:
  set floatProperty(double value) {
    final _$$ref = object$.ref;
    _objc_msgSend_1gv17gn(_$$ref.pointer, _sel_setFloatProperty_, value);
  }

  /// setReadWriteProperty:
  set readWriteProperty(int value) {
    final _$$ref = object$.ref;
    _objc_msgSend_1f6q4sj(_$$ref.pointer, _sel_setReadWriteProperty_, value);
  }

  /// setStructProperty:
  set structProperty(Vec4 value) {
    final _$$ref = object$.ref;
    _objc_msgSend_19l0oqy(_$$ref.pointer, _sel_setStructProperty_, value);
  }
...
final _objc_msgSend_kh8q6e = objc.msgSendPointer
    ...
    >();
final _objc_msgSend_kh8q6eFpret = objc.msgSendFpretPointer
    .cast<
      ffi.NativeFunction<
        ffi.Float Function(
          ffi.Pointer<objc.ObjCObjectImpl>,
