...
>()
external int _pyqkbm_protocolTrampoline_1er77tf(
...
extension type MySwiftClass._(objc.ObjCObject object$)
  ...
  static MySwiftClass alloc() {
    final $ret = _objc_msgSend_zldla2(_class_MySwiftClass, _sel_alloc);
  ...
  static MySwiftClass new$() {
    final $ret = _objc_msgSend_zldla2(_class_MySwiftClass, _sel_new);
    return MySwiftClass.fromPointer($ret, retain: false, release: true);
  }
...
extension MySwiftClass$Methods on MySwiftClass {
  ...
  DartNSInteger getValue() {
    ...
    return _objc_msgSend_18szuw0(_$$ref.pointer, _sel_getValue);
  }
  ...
  void setValueWithX(DartNSInteger x) {
    final _$$ref = object$.ref;
    _objc_msgSend_1whyqxt(_$$ref.pointer, _sel_setValueWithX_, x);
  }
}
...
interface class MySwiftProtocol$Builder {
  ...
  static final getValue = objc.ObjCProtocolMethod<DartNSInteger Function()>(
    ...
    ffi.Native.addressOf<
          ...
          >
        >(_pyqkbm_protocolTrampoline_1er77tf)
        .cast(),
