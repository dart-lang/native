...
Protocol* _1pjmhxm_MethodFilteringTestProtocol(void) { return @protocol(MethodFilteringTestProtocol); }

typedef id  (^_ProtocolTrampoline)(void * sel);
__attribute__((visibility("default"))) __attribute__((used))
id  _1pjmhxm_protocolTrampoline_1mbt9g9(id target, void * sel) {
