...
external void _vy9kn_protocolTrampoline_18v1jvf(ffi.Pointer<objc.ObjCObjectImpl> target,
ffi.Pointer<ffi.Void> arg0,
ffi.Pointer<objc.ObjCObjectImpl> arg1,
);

@ffi.Native<ffi.Bool Function(ffi.Pointer<objc.ObjCObjectImpl> , ffi.Pointer<ffi.Void> )>()
external bool _vy9kn_protocolTrampoline_e3qsqz(ffi.Pointer<objc.ObjCObjectImpl> target,
ffi.Pointer<ffi.Void> arg0,
);

@ffi.Native<instancetype Function(ffi.Pointer<objc.ObjCObjectImpl> , ffi.Pointer<ffi.Void> , ffi.Pointer<objc.ObjCObjectImpl> )>()
external instancetype _vy9kn_protocolTrampoline_xr62hr(ffi.Pointer<objc.ObjCObjectImpl> target,
ffi.Pointer<ffi.Void> arg0,
ffi.Pointer<objc.ObjCObjectImpl> arg1,
);
...
external ffi.Pointer<objc.ObjCBlockImpl> _vy9kn_wrapBlockingBlock_18v1jvf(ffi.Pointer<objc.ObjCBlockImpl> block,
ffi.Pointer<objc.ObjCBlockImpl> listnerBlock,
ffi.Pointer<objc.DOBJC_Context> context,
);

@ffi.Native<ffi.Pointer<objc.ObjCBlockImpl> Function(ffi.Pointer<objc.ObjCBlockImpl> )>(isLeaf: true)
external ffi.Pointer<objc.ObjCBlockImpl> _vy9kn_wrapListenerBlock_18v1jvf(ffi.Pointer<objc.ObjCBlockImpl> block,
);
...
abstract final class ObjCBlock_ffiVoid_ffiVoid_NSCoder {
  ...
  static objc.ObjCBlock<ffi.Void Function(ffi.Pointer<ffi.Void>, objc.NSCoder)> blocking(void Function(ffi.Pointer<ffi.Void> , objc.NSCoder ) fn,
    ...
    final rawListener = objc.newClosureBlock(
        ...
        (ffi.Pointer<ffi.Void> arg0, ffi.Pointer<objc.ObjCObjectImpl> arg1) => fn(arg0, objc.NSCoder.fromPointer(arg1, retain: false, release: true)), keepIsolateAlive);
    final wrapper = _vy9kn_wrapBlockingBlock_18v1jvf(raw, rawListener, objc.objCContext);
    objc.objectRelease(raw.cast());
...
extension type SFTranscriptionSegment._(objc.ObjCObject object$) implements objc.ObjCObject,objc.NSObject,objc.NSCopying,objc.NSSecureCoding {
  ...
  SFTranscriptionSegment.as(objc.ObjCObject other) : object$ = other {
    objc.checkOsVersionInternal('SFTranscriptionSegment', iOS: (false, (10, 0, 0)), macOS: (false, (10, 15, 0)));
    assert(isA(object$));
  }

  /// Constructs a [SFTranscriptionSegment] that wraps the given raw object pointer.
  SFTranscriptionSegment.fromPointer(ffi.Pointer<objc.ObjCObjectImpl> other,
      {bool retain = false, bool release = false}) :
  ...
  static bool isA(objc.ObjCObject obj) => _objc_msgSend_19nvye5(obj.ref.pointer, _sel_isKindOfClass_, _class_SFTranscriptionSegment);

  /// alloc
  static SFTranscriptionSegment alloc() {
    final $ret = _objc_msgSend_151sglz(_class_SFTranscriptionSegment, _sel_alloc);
    return SFTranscriptionSegment.fromPointer($ret, retain: false, release: true);
  }


  /// allocWithZone:
  static SFTranscriptionSegment allocWithZone(ffi.Pointer<objc.NSZone> zone) {
    final $ret = _objc_msgSend_1cwp428(_class_SFTranscriptionSegment, _sel_allocWithZone_, zone);
    return SFTranscriptionSegment.fromPointer($ret, retain: false, release: true);
  }
  ...
  static bool getSupportsSecureCoding() {
    return _objc_msgSend_91o635(_class_SFTranscriptionSegment, _sel_supportsSecureCoding);
...
extension SFTranscriptionSegment$Methods on SFTranscriptionSegment {
  ...
  objc.checkOsVersionInternal('SFTranscriptionSegment.alternativeSubstrings', iOS: (false, (10, 0, 0)), macOS: (false, (10, 15, 0)));
    final $ret = _objc_msgSend_151sglz(object$.ref.pointer, _sel_alternativeSubstrings);
  ...
  objc.checkOsVersionInternal('SFTranscriptionSegment.confidence', iOS: (false, (10, 0, 0)), macOS: (false, (10, 15, 0)));
    return objc.useMsgSendVariants ? _objc_msgSend_2cgrxlFpret(object$.ref.pointer, _sel_confidence) : _objc_msgSend_2cgrxl(object$.ref.pointer, _sel_confidence);
  ...
  /// duration
  double get duration {
  objc.checkOsVersionInternal('SFTranscriptionSegment.duration', iOS: (false, (10, 0, 0)), macOS: (false, (10, 15, 0)));
...
_objc_msgSend_xtuoz7(object$.ref.pointer, _sel_encodeWithCoder_, coder.ref.pointer);
  ...
  objc.checkOsVersionInternal('SFTranscriptionSegment.init', iOS: (false, (2, 0, 0)), macOS: (false, (10, 0, 0)));
  ...
  SFTranscriptionSegment? initWithCoder(objc.NSCoder coder) {
    ...
    return $ret.address == 0 ? null : SFTranscriptionSegment.fromPointer($ret, retain: false, release: true);
  }


  /// substring
  objc.NSString get substring {
  objc.checkOsVersionInternal('SFTranscriptionSegment.substring', iOS: (false, (10, 0, 0)), macOS: (false, (10, 15, 0)));
  ...
  objc.checkOsVersionInternal('SFTranscriptionSegment.substringRange', iOS: (false, (10, 0, 0)), macOS: (false, (10, 15, 0)));
    final $ptr = pkg_ffi.calloc<objc.NSRange>();
    objc.useMsgSendVariants ? _objc_msgSend_1u11dbbStret($ptr, object$.ref.pointer, _sel_substringRange) : $ptr.ref = _objc_msgSend_1u11dbb(object$.ref.pointer, _sel_substringRange);
    final $finalizable = $ptr.cast<ffi.Uint8>().asTypedList(
        ffi.sizeOf<objc.NSRange>(), finalizer: pkg_ffi.calloc.nativeFree);
    return ffi.Struct.create<objc.NSRange>(
        $finalizable);
  ...
  objc.checkOsVersionInternal('SFTranscriptionSegment.timestamp', iOS: (false, (10, 0, 0)), macOS: (false, (10, 15, 0)));
    return objc.useMsgSendVariants ? _objc_msgSend_1ukqyt8Fpret(object$.ref.pointer, _sel_timestamp) : _objc_msgSend_1ukqyt8(object$.ref.pointer, _sel_timestamp);
  ...
  objc.checkOsVersionInternal('SFTranscriptionSegment.voiceAnalytics', macOS: (false, (10, 15, 0)));
    final $ret = _objc_msgSend_151sglz(object$.ref.pointer, _sel_voiceAnalytics);
    return $ret.address == 0 ? null : SFVoiceAnalytics.fromPointer($ret, retain: true, release: true);
  }
...
///
/// SFVoiceAnalytics
extension type SFVoiceAnalytics._(objc.ObjCObject object$) implements objc.ObjCObject,objc.NSObject,objc.NSCopying,objc.NSSecureCoding {
  ...
  SFVoiceAnalytics.as(objc.ObjCObject other) : object$ = other {
    objc.checkOsVersionInternal('SFVoiceAnalytics', iOS: (false, (13, 0, 0)), macOS: (false, (10, 15, 0)));
  }

  /// Constructs a [SFVoiceAnalytics] that wraps the given raw object pointer.
  SFVoiceAnalytics.fromPointer(ffi.Pointer<objc.ObjCObjectImpl> other,
      {bool retain = false, bool release = false}) :
          object$ = objc.ObjCObject(other, retain: retain, release: release) {
    objc.checkOsVersionInternal('SFVoiceAnalytics', iOS: (false, (13, 0, 0)), macOS: (false, (10, 15, 0)));
  }
...
late final _class_SFTranscriptionSegment = objc.getClass("SFTranscriptionSegment");
...
final _objc_msgSend_1u11dbb = objc.msgSendPointer.cast<ffi.NativeFunction<objc.NSRange Function(ffi.Pointer<objc.ObjCObjectImpl> , ffi.Pointer<objc.ObjCSelector> )>>().asFunction<objc.NSRange Function(ffi.Pointer<objc.ObjCObjectImpl> , ffi.Pointer<objc.ObjCSelector> )>();
final _objc_msgSend_1u11dbbStret = objc.msgSendStretPointer.cast<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<objc.NSRange> , ffi.Pointer<objc.ObjCObjectImpl> , ffi.Pointer<objc.ObjCSelector> )>>().asFunction<void Function(ffi.Pointer<objc.NSRange> , ffi.Pointer<objc.ObjCObjectImpl> , ffi.Pointer<objc.ObjCSelector> )>();
