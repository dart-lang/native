...
class StaticFuncTestObjCLibrary {
  ...
  late final _fooPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Int)>>(
    'foo',
  );
  late final _foo = _fooPtr.asFunction<int Function(int)>();
  ...
  late final _fooPtr$1 = _fooPtrPtr.asFunction<int Function(int)>();
