...
Protocol* _qs41jc_EmptyProtocol(void) { return @protocol(EmptyProtocol); }

Protocol* _qs41jc_MyProtocol(void) { return @protocol(MyProtocol); }

typedef int32_t  (^_ProtocolTrampoline)(void * sel);
__attribute__((visibility("default"))) __attribute__((used))
int32_t  _qs41jc_protocolTrampoline_1d4mjzg(id target, void * sel) {
...
__attribute__((visibility("default"))) __attribute__((used))
int32_t  _qs41jc_protocolTrampoline_ct0ie0(id target, void * sel, int32_t arg1, int32_t arg2, int32_t arg3, int32_t arg4) {
...
__attribute__((visibility("default"))) __attribute__((used))
int32_t  _qs41jc_protocolTrampoline_1pfwxcz(id target, void * sel, SomeStruct arg1) {
...
__attribute__((visibility("default"))) __attribute__((used))
id  _qs41jc_protocolTrampoline_1s2pox8(id target, void * sel, id arg1, double arg2) {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline _qs41jc_wrapListenerBlock_1pbq496(_ListenerTrampoline block) NS_RETURNS_RETAINED {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline _qs41jc_wrapBlockingBlock_1pbq496(
...
__attribute__((visibility("default"))) __attribute__((used))
void  _qs41jc_protocolTrampoline_1pbq496(id target, void * sel, int32_t arg1) {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_1 _qs41jc_wrapListenerBlock_8r9qkg(_ListenerTrampoline_1 block) NS_RETURNS_RETAINED {
  return ^void(void * arg0, int32_t * arg1) {
    objc_retainBlock(block);
    block(arg0, arg1);
  };
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_1 _qs41jc_wrapBlockingBlock_8r9qkg(
...
__attribute__((visibility("default"))) __attribute__((used))
void  _qs41jc_protocolTrampoline_8r9qkg(id target, void * sel, int32_t * arg1) {
...
__attribute__((visibility("default"))) __attribute__((used))
id  _qs41jc_protocolTrampoline_1mbt9g9(id target, void * sel) {
  return ((_ProtocolTrampoline_6)((id (*)(id, SEL, SEL))objc_msgSend)(target, @selector(getDOBJCDartProtocolMethodForSelector:), sel))(sel);
}

Protocol* _qs41jc_SecondaryProtocol(void) { return @protocol(SecondaryProtocol); }

Protocol* _qs41jc_UnusedProtocol(void) { return @protocol(UnusedProtocol); }
