...
extension type Foo._(objc.ObjCObject object$)
  ...
  static bool isA(objc.ObjCObject? obj) => obj == null
      ? false
      : _objc_msgSend_xbndyy(obj.ref.pointer, _sel_isKindOfClass_, _class_Foo);

  /// alloc
  static Foo alloc() {
    final $ret = _objc_msgSend_zldla2(_class_Foo, _sel_alloc);
    return Foo.fromPointer($ret, retain: false, release: true);
  }

  /// allocWithZone:
  static Foo allocWithZone(ffi.Pointer<objc.NSZone> zone) {
    final $ret = _objc_msgSend_1h5ffc5(_class_Foo, _sel_allocWithZone_, zone);
    return Foo.fromPointer($ret, retain: false, release: true);
  }

  /// makeFoo:
  static Foo makeFoo(double x) {
    final $ret = _objc_msgSend_1qido3(_class_Foo, _sel_makeFoo_, x);
    return Foo.fromPointer($ret, retain: true, release: true);
  }

  /// new
  static Foo new$() {
    final $ret = _objc_msgSend_zldla2(_class_Foo, _sel_new);
    return Foo.fromPointer($ret, retain: false, release: true);
  }
...
extension Foo$Methods on Foo {
  ...
  bool get boolVal {
    ...
    return _objc_msgSend_13h8okt(_$$ref.pointer, _sel_boolVal);
  }

  /// classVal
  objc.ObjCObject get classVal {
    final _$$ref = object$.ref;
    final $ret = _objc_msgSend_zldla2(_$$ref.pointer, _sel_classVal);
  ...
  objc.ObjCObject get idVal {
    final _$$ref = object$.ref;
    final $ret = _objc_msgSend_zldla2(_$$ref.pointer, _sel_idVal);
    return objc.ObjCObject($ret, retain: true, release: true);
  }
  ...
  int get intVal {
    final _$$ref = object$.ref;
    return _objc_msgSend_1etqkvi(_$$ref.pointer, _sel_intVal);
  }
  ...
  objc.NSObject get objVal {
    final _$$ref = object$.ref;
    final $ret = _objc_msgSend_zldla2(_$$ref.pointer, _sel_objVal);
  ...
  ffi.Pointer<objc.ObjCSelector> get selVal {
    final _$$ref = object$.ref;
    return _objc_msgSend_1fen6hj(_$$ref.pointer, _sel_selVal);
  }

  /// setBoolVal:
  set boolVal(bool value) {
    final _$$ref = object$.ref;
    _objc_msgSend_1s4gila(_$$ref.pointer, _sel_setBoolVal_, value);
  }
  ...
  set classVal(objc.ObjCObject value) {
    ...
    _objc_msgSend_1d1siln(_$$ref.pointer, _sel_setClassVal_, _$$ref$1.pointer);
  }

  /// setDoubleVal:
  void setDoubleVal(double x) {
    final _$$ref = object$.ref;
    _objc_msgSend_q6vpml(_$$ref.pointer, _sel_setDoubleVal_, x);
  }
  ...
  set idVal(objc.ObjCObject value) {
    final _$$ref = object$.ref;
    final _$$ref$1 = value.ref;
    _objc_msgSend_1d1siln(_$$ref.pointer, _sel_setIdVal_, _$$ref$1.pointer);
  }

  /// setIntVal:
  set intVal(int value) {
    final _$$ref = object$.ref;
    _objc_msgSend_1f6q4sj(_$$ref.pointer, _sel_setIntVal_, value);
  }
  ...
  set objVal(objc.NSObject value) {
    final _$$ref = object$.ref;
    final _$$ref$1 = value.ref;
    _objc_msgSend_1d1siln(_$$ref.pointer, _sel_setObjVal_, _$$ref$1.pointer);
  }

  /// setSelVal:
  set selVal(ffi.Pointer<objc.ObjCSelector> value) {
    final _$$ref = object$.ref;
    _objc_msgSend_j5cnrc(_$$ref.pointer, _sel_setSelVal_, value);
  }
}
...
final _objc_msgSend_13h8okt = objc.msgSendPointer
    ...
    >();
final _objc_msgSend_13w5pef = objc.msgSendPointer
    .cast<
      ffi.NativeFunction<
        ffi.Int32 Function(
          ffi.Pointer<objc.ObjCObjectImpl>,
