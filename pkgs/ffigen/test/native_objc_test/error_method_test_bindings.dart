...
extension type ErrorMethodTestObject._(objc.ObjCObject object$)
  ...
  static ErrorMethodTestObject alloc() {
    final $ret = _objc_msgSend_zldla2(_class_ErrorMethodTestObject, _sel_alloc);
  ...
  static ErrorMethodTestObject new$() {
    final $ret = _objc_msgSend_zldla2(_class_ErrorMethodTestObject, _sel_new);
    return ErrorMethodTestObject.fromPointer(
      $ret,
      retain: false,
      release: true,
...
extension ErrorMethodTestObject$Methods on ErrorMethodTestObject {
  ...
  bool errorMethodReturningBool(bool isOk) {
    ...
    try {
      final $ret = _objc_msgSend_1d50bq7(
        _$$ref.pointer,
  ...
  objc.NSObject? errorMethodReturningNullable(bool isOk) {
    ...
    final $err = pkg_ffi.calloc<ffi.Pointer<objc.ObjCObjectImpl>>();
    try {
      final $ret = _objc_msgSend_1utlnmg(
        _$$ref.pointer,
