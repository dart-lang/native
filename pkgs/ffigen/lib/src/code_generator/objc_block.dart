...
''';
  ...
  @override
  String getCType(Context _) => PointerType(objCBlockType).getCType(context);
  ...
  @override
  String getDartType(Context _) => _blockType();

  @override
  String getObjCBlockSignatureType(Context _) => getDartType(context);
