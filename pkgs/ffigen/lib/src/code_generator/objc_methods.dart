...
mixin ObjCMethods {
  ...
  void copyMethod(ObjCMethod method, {ObjCCategory? category}) {
    ...
    if (category != null) {
      cloned.originalCategory = category;
      cloned.setter?.originalCategory = category;
    }
    addMethod(cloned);
...
class ObjCMethod extends AstNode with HasLocalScope {
  ...
  ObjCMethod _cloneWithSymbol(Symbol newSymbol, {ObjCMethods? parent}) {
    ...
    clonedMethod.originalCategory = originalCategory;
    return clonedMethod;
  }
