...
final class YamlConfig {
  ...
  FfiGenerator configAdapter() => FfiGenerator(
    ...
    functions: Functions(
      ...
      shouldIncludeMember: functionDecl.shouldIncludeMember,
      rename: functionDecl.rename,
      renameMember: functionDecl.renameMember,
      varArgs: varArgFunctions,
      exposeTypedef: shouldExposeFunctionTypedef,
      isLeaf: isLeafFunction,
    ),
    structs: Structs(
      shouldInclude: _structDecl.shouldInclude,
      shouldIncludeSymbolAddress: _structDecl.shouldIncludeSymbolAddress,
      shouldIncludeMember: _structDecl.shouldIncludeMember,
    ...
    enums: Enums(
      ...
      shouldIncludeSymbolAddress: _enumClassDecl.shouldIncludeSymbolAddress,
      shouldIncludeMember: _enumClassDecl.shouldIncludeMember,
