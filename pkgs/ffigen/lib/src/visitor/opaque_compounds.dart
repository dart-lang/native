...
class ClearOpaqueCompoundMembersVisitation extends Visitation {
  ...
  void _visitImpl(Compound node) {
    // If a compound isn't referred to by value, isn't explicitly included by
    // the config filters, and the compound is configured with opaque deps,
    // convert the compound to be opaque by deleting its members.
