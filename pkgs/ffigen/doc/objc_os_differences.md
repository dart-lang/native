...
<!-- file://./../tool/snippets/os_differences_snippet.dart#single_wrapper -->
```dart
final foo = Foo();
if (Platform.isMacOS) {
...
<!-- file://./../tool/snippets/os_differences_snippet.dart#renamed_apis -->
```dart
if (Platform.isMacOS) {
...
<!-- file://./../tool/snippets/web_view_snippet.dart -->
```dart
...
<!-- file://./../tool/snippets/os_version_snippet.dart -->
```dart
