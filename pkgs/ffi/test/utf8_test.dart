...
void main() {
  test('toUtf8 ASCII', () {
    ...
    final converted = start.toNativeUtf8().cast() as Pointer<Uint8>;
  ...
  test('toUtf8 emoji', () {
    final start = '😎👿💬';
    final converted = start.toNativeUtf8().cast() as Pointer<Utf8>;
  ...
  test('fromUtf8 invalid', () {
    final utf8 = _bytesFromList([0x80, 0x00]).cast() as Pointer<Utf8>;
