...
@objc public class AVCaptureBracketedStillImageSettingsWrapper: NSObject {
  var wrappedInstance: AVCaptureBracketedStillImageSettings
  
  init(_ wrappedInstance: AVCaptureBracketedStillImageSettings) {
    self.wrappedInstance = wrappedInstance
  }
}

@objc public class AVCaptureDeferredPhotoProxyWrapper: NSObject {
  var wrappedInstance: AVCaptureDeferredPhotoProxy
  
  init(_ wrappedInstance: AVCaptureDeferredPhotoProxy) {
    self.wrappedInstance = wrappedInstance
  }
}
...
@objc public class AVSampleBufferGeneratorBatchWrapper: NSObject {
  ...
  @objc func makeDataReady() -> Void {
    return wrappedInstance.makeDataReady()
  }
