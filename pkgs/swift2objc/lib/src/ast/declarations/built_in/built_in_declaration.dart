...
const _objectDecl = BuiltInDeclaration(id: 'c:objc(cs)NSObject', name: 'NSObject');
...
const builtInDeclarations = [
  ...
  BuiltInDeclaration(id: 's:10Foundation15AffineTransformV', name: 'AffineTransform'),
  ...
  BuiltInDeclaration(id: 's:10Foundation14DateComponentsV', name: 'DateComponents'),
  ...
  BuiltInDeclaration(id: 's:10Foundation13URLComponentsV', name: 'URLComponents'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSNetServiceBrowser', name: 'NetServiceBrowser'),
  BuiltInDeclaration(id: 'c:objc(cs)NSAttributedString ', name: 'NSAttributedString'),
  BuiltInDeclaration(id: 'c:objc(cs)NSMeasurement', name: 'NSMeasurement'),
  BuiltInDeclaration(id: 'c:objc(cs)NSCoder', name: 'NSCoder'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUniqueIDSpecifier', name: 'NSUniqueIDSpecifier'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSPointerFunctions ', name: 'NSPointerFunctions'),
  BuiltInDeclaration(id: 'c:objc(cs)NSProcessInfo', name: 'ProcessInfo'),
  BuiltInDeclaration(id: 'c:objc(cs)NSCachedURLResponse', name: 'CachedURLResponse'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSPersonNameComponents ', name: 'NSPersonNameComponents'),
  BuiltInDeclaration(id: 'c:objc(cs)NSKeyedArchiver', name: 'NSKeyedArchiver'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLCredentialStorage ', name: 'URLCredentialStorage'),
  BuiltInDeclaration(id: 'c:objc(cs)NSDecimalNumberHandler ', name: 'NSDecimalNumberHandler'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLSessionWebSocketTask', name: 'URLSessionWebSocketTask'),
  BuiltInDeclaration(id: 'c:objc(cs)NSFileCoordinator', name: 'NSFileCoordinator'),
  BuiltInDeclaration(id: 'c:objc(cs)NSLocale ', name: 'NSLocale'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLSession ', name: 'URLSession'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLSessionDataTask ', name: 'URLSessionDataTask'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLResponse', name: 'URLResponse'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitElectricCharge ', name: 'UnitElectricCharge'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitDuration ', name: 'UnitDuration'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLSessionDownloadTask ', name: 'URLSessionDownloadTask'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitConverterLinear', name: 'UnitConverterLinear'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLSessionTaskTransactionMetrics ', name: 'URLSessionTaskTransactionMetrics'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitDispersion ', name: 'UnitDispersion'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLSessionStreamTask ', name: 'URLSessionStreamTask'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitConverter', name: 'UnitConverter'),
  BuiltInDeclaration(id: 'c:objc(cs)NSExtensionContext ', name: 'NSExtensionContext'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLSessionUploadTask ', name: 'URLSessionUploadTask'),
  BuiltInDeclaration(id: 'c:objc(cs)NSDateComponents ', name: 'NSDateComponents'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitConcentrationMass', name: 'UnitConcentrationMass'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitAcceleration ', name: 'UnitAcceleration'),
  BuiltInDeclaration(id: 'c:objc(cs)NSXMLNode', name: 'XMLNode'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUbiquitousKeyValueStore', name: 'NSUbiquitousKeyValueStore'),
  BuiltInDeclaration(id: 'c:objc(cs)NSFileAccessIntent ', name: 'NSFileAccessIntent'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSRegularExpression', name: 'NSRegularExpression'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSPropertyListSerialization', name: 'PropertyListSerialization'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSUserScriptTask ', name: 'NSUserScriptTask'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUserAppleScriptTask', name: 'NSUserAppleScriptTask'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSUserAutomatorTask', name: 'NSUserAutomatorTask'),
  BuiltInDeclaration(id: 'c:objc(cs)NSScriptCommand', name: 'NSScriptCommand'),
  BuiltInDeclaration(id: 'c:objc(cs)NSOrderedCollectionDifference', name: 'NSOrderedCollectionDifference'),
  BuiltInDeclaration(id: 'c:objc(cs)NSCloneCommand ', name: 'NSCloneCommand'),
  BuiltInDeclaration(id: 'c:objc(cs)NSOrderedCollectionChange', name: 'NSOrderedCollectionChange'),
  BuiltInDeclaration(id: 'c:objc(cs)NSClassDescription ', name: 'NSClassDescription'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSDirectoryEnumerator', name: 'DirectoryEnumerator'),
  BuiltInDeclaration(id: 'c:objc(cs)NSDateComponentsFormatter', name: 'DateComponentsFormatter'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUserNotificationCenter ', name: 'NSUserNotificationCenter'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSAffineTransform', name: 'NSAffineTransform'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSPersonNameComponentsFormatter', name: 'PersonNameComponentsFormatter'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLSessionConfiguration', name: 'URLSessionConfiguration'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUserNotification ', name: 'NSUserNotification'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUserNotificationAction ', name: 'NSUserNotificationAction'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitIlluminance', name: 'UnitIlluminance'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSScriptWhoseTest', name: 'NSScriptWhoseTest'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitInformationStorage ', name: 'UnitInformationStorage'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitFuelEfficiency ', name: 'UnitFuelEfficiency'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitElectricResistance ', name: 'UnitElectricResistance'),
  BuiltInDeclaration(id: 'c:objc(cs)NSSortDescriptor ', name: 'NSSortDescriptor'),
  BuiltInDeclaration(id: 'c:objc(cs)NSMachPort ', name: 'NSMachPort'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitEnergy ', name: 'UnitEnergy'),
  BuiltInDeclaration(id: 'c:objc(cs)NSNotificationCenter ', name: 'NotificationCenter'),
  BuiltInDeclaration(id: 'c:objc(cs)NSPipe ', name: 'Pipe'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitElectricCurrent', name: 'UnitElectricCurrent'),
  BuiltInDeclaration(id: 'c:objc(cs)NSDateFormatter', name: 'DateFormatter'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitElectricPotentialDifference', name: 'UnitElectricPotentialDifference'),
  BuiltInDeclaration(id: 'c:objc(cs)NSDateIntervalFormatter', name: 'DateIntervalFormatter'),
  BuiltInDeclaration(id: 'c:objc(cs)NSPointerArray ', name: 'NSPointerArray'),
  BuiltInDeclaration(id: 'c:objc(cs)NSByteCountFormatter ', name: 'ByteCountFormatter'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitVolume ', name: 'UnitVolume'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitSpeed', name: 'UnitSpeed'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLSessionTaskMetrics', name: 'URLSessionTaskMetrics'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLProtocol', name: 'URLProtocol'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitTemperature', name: 'UnitTemperature'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSBackgroundActivityScheduler', name: 'NSBackgroundActivityScheduler'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSRelativeSpecifier', name: 'NSRelativeSpecifier'),
  BuiltInDeclaration(id: 'c:objc(cs)NSNull ', name: 'NSNull'),
  BuiltInDeclaration(id: 'c:objc(cs)NSDistributedNotificationCenter', name: 'DistributedNotificationCenter'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSNumberFormatter', name: 'NumberFormatter'),
  BuiltInDeclaration(id: 'c:objc(cs)NSBundle ', name: 'Bundle'),
  BuiltInDeclaration(id: 'c:objc(cs)NSXMLDocument', name: 'XMLDocument'),
  BuiltInDeclaration(id: 'c:objc(cs)NSLinguisticTagger ', name: 'NSLinguisticTagger'),
  BuiltInDeclaration(id: 'c:objc(cs)NSISO8601DateFormatter ', name: 'ISO8601DateFormatter'),
  BuiltInDeclaration(id: 'c:objc(cs)NSHost ', name: 'Host'),
  BuiltInDeclaration(id: 'c:objc(cs)NSWhoseSpecifier ', name: 'NSWhoseSpecifier'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSAppleEventDescriptor ', name: 'NSAppleEventDescriptor'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSScriptClassDescription ', name: 'NSScriptClassDescription'),
  BuiltInDeclaration(id: 'c:objc(cs)NSScriptCoercionHandler', name: 'NSScriptCoercionHandler'),
  BuiltInDeclaration(id: 'c:objc(cs)NSScriptCommandDescription ', name: 'NSScriptCommandDescription'),
  BuiltInDeclaration(id: 'c:objc(cs)NSXMLDTDNode ', name: 'XMLDTDNode'),
  BuiltInDeclaration(id: 'c:objc(cs)NSScriptExecutionContext ', name: 'NSScriptExecutionContext'),
  BuiltInDeclaration(id: 'c:objc(cs)NSScriptSuiteRegistry', name: 'NSScriptSuiteRegistry'),
  BuiltInDeclaration(id: 'c:objc(cs)NSCreateCommand', name: 'NSCreateCommand'),
  BuiltInDeclaration(id: 'c:objc(cs)NSMutableIndexSet', name: 'NSMutableIndexSet'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSMutableDictionary', name: 'NSMutableDictionary'),
  BuiltInDeclaration(id: 'c:objc(cs)NSStream ', name: 'Stream'),
  BuiltInDeclaration(id: 'c:objc(cs)NSCountCommand ', name: 'NSCountCommand'),
  BuiltInDeclaration(id: 'c:objc(cs)NSXPCListenerEndpoint', name: 'NSXPCListenerEndpoint'),
  BuiltInDeclaration(id: 'c:objc(cs)NSJSONSerialization', name: 'JSONSerialization'),
  BuiltInDeclaration(id: 'c:objc(cs)NSAssertionHandler ', name: 'NSAssertionHandler'),
  BuiltInDeclaration(id: 'c:objc(cs)NSMutableURLRequest', name: 'NSMutableURLRequest'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSMutableOrderedSet', name: 'NSMutableOrderedSet'),
  BuiltInDeclaration(id: 'c:objc(cs)NSOrderedSet ', name: 'NSOrderedSet'),
  BuiltInDeclaration(id: 'c:objc(cs)NSKeyedUnarchiver', name: 'NSKeyedUnarchiver'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLAuthenticationChallenge ', name: 'URLAuthenticationChallenge'),
  BuiltInDeclaration(id: 'c:objc(cs)NSXPCCoder ', name: 'NSXPCCoder'),
  BuiltInDeclaration(id: 'c:objc(cs)NSKeyValueSharedObservers', name: 'NSKeyValueSharedObservers'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLCache ', name: 'URLCache'),
  BuiltInDeclaration(id: 'c:objc(cs)NSKeyValueSharedObserversSnapshot', name: 'NSKeyValueSharedObserversSnapshot'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSMeasurementFormatter ', name: 'MeasurementFormatter'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSLengthFormatter', name: 'LengthFormatter'),
  BuiltInDeclaration(id: 'c:objc(cs)NSListFormatter', name: 'ListFormatter'),
  BuiltInDeclaration(id: 'c:objc(cs)NSNotificationQueue', name: 'NotificationQueue'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSURLProtectionSpace ', name: 'URLProtectionSpace'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSCompoundPredicate', name: 'NSCompoundPredicate'),
  BuiltInDeclaration(id: 'c:objc(cs)NSComparisonPredicate', name: 'NSComparisonPredicate'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSMutableCharacterSet', name: 'NSMutableCharacterSet'),
  BuiltInDeclaration(id: 'c:objc(cs)NSValueTransformer ', name: 'ValueTransformer'),
  BuiltInDeclaration(id: 'c:objc(cs)NSFileVersion', name: 'NSFileVersion'),
  BuiltInDeclaration(id: 'c:objc(cs)NSSecureUnarchiveFromDataTransformer ', name: 'NSSecureUnarchiveFromDataTransformer'),
  BuiltInDeclaration(id: 'c:objc(cs)NSMutableData', name: 'NSMutableData'),
  BuiltInDeclaration(id: 'c:objc(cs)NSMiddleSpecifier', name: 'NSMiddleSpecifier'),
  BuiltInDeclaration(id: 'c:objc(cs)NSMutableAttributedString', name: 'NSMutableAttributedString'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSMetadataQueryResultGroup ', name: 'NSMetadataQueryResultGroup'),
  BuiltInDeclaration(id: 'c:objc(cs)NSHTTPURLResponse', name: 'HTTPURLResponse'),
  BuiltInDeclaration(id: 'c:objc(cs)NSMetadataQueryAttributeValueTuple ', name: 'NSMetadataQueryAttributeValueTuple'),
  BuiltInDeclaration(id: 'c:objc(cs)NSDistributedLock', name: 'NSDistributedLock'),
  BuiltInDeclaration(id: 'c:objc(cs)NSSpecifierTest', name: 'NSSpecifierTest'),
  BuiltInDeclaration(id: 'c:objc(cs)NSHTTPCookieStorage', name: 'HTTPCookieStorage'),
  BuiltInDeclaration(id: 'c:objc(cs)NSAppleEventManager', name: 'NSAppleEventManager'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSPositionalSpecifier', name: 'NSPositionalSpecifier'),
  BuiltInDeclaration(id: 'c:objc(cs)NSTimer', name: 'Timer'),
  BuiltInDeclaration(id: 'c:objc(cs)NSTask ', name: 'Process'),
  BuiltInDeclaration(id: 'c:objc(cs)NSIndexSpecifier ', name: 'NSIndexSpecifier'),
  BuiltInDeclaration(id: 'c:objc(cs)NSScriptObjectSpecifier', name: 'NSScriptObjectSpecifier'),
  BuiltInDeclaration(id: 'c:objc(cs)NSTextCheckingResult ', name: 'NSTextCheckingResult'),
  BuiltInDeclaration(id: 'c:objc(cs)NSGetCommand ', name: 'NSGetCommand'),
  BuiltInDeclaration(id: 'c:objc(cs)NSPropertySpecifier', name: 'NSPropertySpecifier'),
  ...
  BuiltInDeclaration(id: 'c:objc(cs)NSProtocolChecker', name: 'NSProtocolChecker'),
  BuiltInDeclaration(id: 'c:objc(cs)NSFileProviderService', name: 'NSFileProviderService'),
  BuiltInDeclaration(id: 'c:objc(cs)NSDimension', name: 'Dimension'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnit ', name: 'Unit'),
  BuiltInDeclaration(id: 'c:objc(cs)NSRangeSpecifier ', name: 'NSRangeSpecifier'),
  BuiltInDeclaration(id: 'c:objc(cs)NSQuitCommand', name: 'NSQuitCommand'),
  BuiltInDeclaration(id: 'c:objc(cs)NSRandomSpecifier', name: 'NSRandomSpecifier'),
  BuiltInDeclaration(id: 'c:objc(cs)NSThread ', name: 'Thread'),
  BuiltInDeclaration(id: 'c:objc(cs)NSEnergyFormatter', name: 'EnergyFormatter'),
  BuiltInDeclaration(id: 'c:objc(cs)NSRecursiveLock', name: 'NSRecursiveLock'),
  BuiltInDeclaration(id: 'c:objc(cs)NSRelativeDateTimeFormatter', name: 'RelativeDateTimeFormatter'),
