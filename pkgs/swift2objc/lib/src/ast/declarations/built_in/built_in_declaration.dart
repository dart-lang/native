...
const builtInDeclarations = [
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSNetServiceBrowser', name: 'NetServiceBrowser'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSAttributedString ', name: 'NSAttributedString'),
  BuiltInDeclaration(id: 'c:objc(cs)NSMeasurement', name: 'NSMeasurement'),
  BuiltInDeclaration(id: 'c:objc(cs)NSCoder', name: 'NSCoder'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSUniqueIDSpecifier', name: 'NSUniqueIDSpecifier'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSPointerFunctions ', name: 'NSPointerFunctions'),
  BuiltInDeclaration(id: 'c:objc(cs)NSProcessInfo', name: 'ProcessInfo'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSCachedURLResponse', name: 'CachedURLResponse'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSPersonNameComponents ', name: 'NSPersonNameComponents'),
  BuiltInDeclaration(id: 'c:objc(cs)NSKeyedArchiver', name: 'NSKeyedArchiver'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSURLCredentialStorage ', name: 'URLCredentialStorage'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSDecimalNumberHandler ', name: 'NSDecimalNumberHandler'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSURLSessionWebSocketTask',
      name: 'URLSessionWebSocketTask'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSFileCoordinator', name: 'NSFileCoordinator'),
  BuiltInDeclaration(id: 'c:objc(cs)NSLocale ', name: 'NSLocale'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLSession ', name: 'URLSession'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSURLSessionDataTask ', name: 'URLSessionDataTask'),
  BuiltInDeclaration(id: 'c:objc(cs)NSURLResponse', name: 'URLResponse'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSUnitElectricCharge ', name: 'UnitElectricCharge'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSUnitConverterLinear', name: 'UnitConverterLinear'),
  BuiltInDeclaration(
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSURLSessionStreamTask ', name: 'URLSessionStreamTask'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnitConverter', name: 'UnitConverter'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSExtensionContext ', name: 'NSExtensionContext'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSURLSessionUploadTask ', name: 'URLSessionUploadTask'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSDateComponents ', name: 'NSDateComponents'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSUnitConcentrationMass', name: 'UnitConcentrationMass'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSUnitAcceleration ', name: 'UnitAcceleration'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSFileAccessIntent ', name: 'NSFileAccessIntent'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSRegularExpression', name: 'NSRegularExpression'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSUserScriptTask ', name: 'NSUserScriptTask'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSUserAppleScriptTask', name: 'NSUserAppleScriptTask'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSUserAutomatorTask', name: 'NSUserAutomatorTask'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSClassDescription ', name: 'NSClassDescription'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSDirectoryEnumerator', name: 'DirectoryEnumerator'),
  BuiltInDeclaration(
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSAffineTransform', name: 'NSAffineTransform'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSUserNotification ', name: 'NSUserNotification'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSUserNotificationAction ',
      name: 'NSUserNotificationAction'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSUnitIlluminance', name: 'UnitIlluminance'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSScriptWhoseTest', name: 'NSScriptWhoseTest'),
  BuiltInDeclaration(
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSRelativeSpecifier', name: 'NSRelativeSpecifier'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSNumberFormatter', name: 'NumberFormatter'),
  BuiltInDeclaration(id: 'c:objc(cs)NSBundle ', name: 'Bundle'),
  BuiltInDeclaration(id: 'c:objc(cs)NSXMLDocument', name: 'XMLDocument'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSLinguisticTagger ', name: 'NSLinguisticTagger'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSISO8601DateFormatter ', name: 'ISO8601DateFormatter'),
  BuiltInDeclaration(id: 'c:objc(cs)NSHost ', name: 'Host'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSWhoseSpecifier ', name: 'NSWhoseSpecifier'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSAppleEventDescriptor ', name: 'NSAppleEventDescriptor'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSScriptCoercionHandler', name: 'NSScriptCoercionHandler'),
  BuiltInDeclaration(
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSScriptSuiteRegistry', name: 'NSScriptSuiteRegistry'),
  BuiltInDeclaration(id: 'c:objc(cs)NSCreateCommand', name: 'NSCreateCommand'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSMutableIndexSet', name: 'NSMutableIndexSet'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSMutableDictionary', name: 'NSMutableDictionary'),
  BuiltInDeclaration(id: 'c:objc(cs)NSStream ', name: 'Stream'),
  BuiltInDeclaration(id: 'c:objc(cs)NSCountCommand ', name: 'NSCountCommand'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSXPCListenerEndpoint', name: 'NSXPCListenerEndpoint'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSJSONSerialization', name: 'JSONSerialization'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSAssertionHandler ', name: 'NSAssertionHandler'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSMutableURLRequest', name: 'NSMutableURLRequest'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSMutableOrderedSet', name: 'NSMutableOrderedSet'),
  BuiltInDeclaration(id: 'c:objc(cs)NSOrderedSet ', name: 'NSOrderedSet'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSKeyedUnarchiver', name: 'NSKeyedUnarchiver'),
  BuiltInDeclaration(
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSMeasurementFormatter ', name: 'MeasurementFormatter'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSLengthFormatter', name: 'LengthFormatter'),
  BuiltInDeclaration(id: 'c:objc(cs)NSListFormatter', name: 'ListFormatter'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSNotificationQueue', name: 'NotificationQueue'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSURLProtectionSpace ', name: 'URLProtectionSpace'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSCompoundPredicate', name: 'NSCompoundPredicate'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSComparisonPredicate', name: 'NSComparisonPredicate'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSMutableCharacterSet', name: 'NSMutableCharacterSet'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSValueTransformer ', name: 'ValueTransformer'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSMiddleSpecifier', name: 'NSMiddleSpecifier'),
  BuiltInDeclaration(
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSHTTPURLResponse', name: 'HTTPURLResponse'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSMetadataQueryAttributeValueTuple ',
      name: 'NSMetadataQueryAttributeValueTuple'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSDistributedLock', name: 'NSDistributedLock'),
  BuiltInDeclaration(id: 'c:objc(cs)NSSpecifierTest', name: 'NSSpecifierTest'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSHTTPCookieStorage', name: 'HTTPCookieStorage'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSAppleEventManager', name: 'NSAppleEventManager'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSPositionalSpecifier', name: 'NSPositionalSpecifier'),
  BuiltInDeclaration(id: 'c:objc(cs)NSTimer', name: 'Timer'),
  BuiltInDeclaration(id: 'c:objc(cs)NSTask ', name: 'Process'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSIndexSpecifier ', name: 'NSIndexSpecifier'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSScriptObjectSpecifier', name: 'NSScriptObjectSpecifier'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSTextCheckingResult ', name: 'NSTextCheckingResult'),
  BuiltInDeclaration(id: 'c:objc(cs)NSGetCommand ', name: 'NSGetCommand'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSPropertySpecifier', name: 'NSPropertySpecifier'),
  ...
  BuiltInDeclaration(
      id: 'c:objc(cs)NSProtocolChecker', name: 'NSProtocolChecker'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSFileProviderService', name: 'NSFileProviderService'),
  BuiltInDeclaration(id: 'c:objc(cs)NSDimension', name: 'Dimension'),
  BuiltInDeclaration(id: 'c:objc(cs)NSUnit ', name: 'Unit'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSRangeSpecifier ', name: 'NSRangeSpecifier'),
  BuiltInDeclaration(id: 'c:objc(cs)NSQuitCommand', name: 'NSQuitCommand'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSRandomSpecifier', name: 'NSRandomSpecifier'),
  BuiltInDeclaration(id: 'c:objc(cs)NSThread ', name: 'Thread'),
  BuiltInDeclaration(
      id: 'c:objc(cs)NSEnergyFormatter', name: 'EnergyFormatter'),
