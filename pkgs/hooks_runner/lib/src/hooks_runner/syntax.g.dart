...
// Must be rerun when pkgs/hooks_runner/doc/schema/ is modified.
...
class ConfigExtensionsSyntax extends JsonObjectSyntax {
  ConfigExtensionsSyntax.fromJson(
    super.json, {
    super.path = const [],
  }) : super.fromJson();

  ConfigExtensionsSyntax({
    required HooksRunnerConfigSyntax? hooksRunner,
    super.path = const [],
  }) : super() {
  ...
  HooksRunnerConfigSyntax? get hooksRunner {
    final jsonValue = _reader.optionalMap('hooks_runner');
    if (jsonValue == null) return null;
    return HooksRunnerConfigSyntax.fromJson(
      jsonValue,
      path: [...path, 'hooks_runner'],
    );
  }

  set hooksRunner(HooksRunnerConfigSyntax? value) {
    json.setOrRemove('hooks_runner', value?.json);
    json.sortOnKey();
  }

  List<String> _validateHooksRunner() {
    final mapErrors = _reader.validate<Map<String, Object?>?>('hooks_runner');
    if (mapErrors.isNotEmpty) {
      return mapErrors;
    }
    return hooksRunner?.validate() ?? [];
  }

  @override
  List<String> validate() => [...super.validate(), ..._validateHooksRunner()];

  @override
  String toString() => 'ConfigExtensionsSyntax($json)';
}

class HooksRunnerConfigSyntax extends JsonObjectSyntax {
  HooksRunnerConfigSyntax.fromJson(
    super.json, {
    super.path = const [],
  }) : super.fromJson();

  HooksRunnerConfigSyntax({
    required RecordUseConfigSyntax? recordUse,
    super.path = const [],
  }) : super() {
  ...
  RecordUseConfigSyntax? get recordUse {
    final jsonValue = _reader.optionalMap('record_use');
    if (jsonValue == null) return null;
    return RecordUseConfigSyntax.fromJson(
      jsonValue,
      path: [...path, 'record_use'],
    );
  }

  set _recordUse(RecordUseConfigSyntax? value) {
    json.setOrRemove('record_use', value?.json);
  }

  List<String> _validateRecordUse() {
    final mapErrors = _reader.validate<Map<String, Object?>?>('record_use');
    if (mapErrors.isNotEmpty) {
      return mapErrors;
    }
    return recordUse?.validate() ?? [];
  }

  @override
  List<String> validate() => [...super.validate(), ..._validateRecordUse()];

  @override
  String toString() => 'HooksRunnerConfigSyntax($json)';
}

class RecordUseConfigSyntax extends JsonObjectSyntax {
  RecordUseConfigSyntax.fromJson(
    super.json, {
    super.path = const [],
  }) : super.fromJson();

  RecordUseConfigSyntax({
  ...
  String get compiler => _reader.get<String>('compiler');

  set _compiler(String value) {
    json.setOrRemove('compiler', value);
  }

  List<String> _validateCompiler() => _reader.validate<String>('compiler');

  List<String> get entryPoints => _reader.stringList('entry_points');

  set _entryPoints(List<String> value) {
    json['entry_points'] = value;
  }

  List<String> _validateEntryPoints() =>
      _reader.validateStringList('entry_points');

  @override
  List<String> validate() => [
    ...super.validate(),
    ..._validateCompiler(),
    ..._validateEntryPoints(),
  ];

  @override
  String toString() => 'RecordUseConfigSyntax($json)';
}
