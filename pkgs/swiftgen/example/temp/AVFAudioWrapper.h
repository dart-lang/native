...
- (void)scheduleBuffer:(AVAudioPCMBufferWrapper * _Nonnull)buffer completionHandler:(void (^ _Nonnull)(void))completionHandler;
- (void)scheduleFile:(AVAudioFileWrapper * _Nonnull)file at:(AVAudioTimeWrapper * _Nullable)when completionHandler:(void (^ _Nonnull)(void))completionHandler;
- (void)stop;
@end
